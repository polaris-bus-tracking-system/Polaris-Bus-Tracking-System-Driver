...
public class BusTracking extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Driver").child(userID).child("location");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(22.7072229, 75.8559028);
        myMarker = mMap.addMarker(new MarkerOptions().position(sydney).title("Bus Location")
